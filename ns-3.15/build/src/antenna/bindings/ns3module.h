...
public:
    ...
    static PyObject * _wrap_DoStart(PyNs3AntennaModel *self);
...
public:
    ...
    static PyObject * _wrap_DoStart(PyNs3CosineAntennaModel *self);
    inline void DoStart__parent_caller()
    { ns3::Object::DoStart(); }
...
public:
    ...
    static PyObject * _wrap_DoStart(PyNs3IsotropicAntennaModel *self);
    inline void DoStart__parent_caller()
    { ns3::Object::DoStart(); }
...
public:
    ...
    static PyObject * _wrap_DoStart(PyNs3ParabolicAntennaModel *self);
    inline void DoStart__parent_caller()
    { ns3::Object::DoStart(); }
