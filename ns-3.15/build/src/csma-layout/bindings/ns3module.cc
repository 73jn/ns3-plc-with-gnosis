...
static PyMethodDef PyNs3CsmaStarHelper_methods[] = {
    {(char *) "GetHubIpv6Address", (PyCFunction) _wrap_PyNs3CsmaStarHelper_GetHubIpv6Address, METH_KEYWORDS|METH_VARARGS, NULL },
    ...
    {(char *) "AssignIpv6Addresses", (PyCFunction) _wrap_PyNs3CsmaStarHelper_AssignIpv6Addresses, METH_KEYWORDS|METH_VARARGS, NULL },
    {(char *) "GetSpokeIpv6Address", (PyCFunction) _wrap_PyNs3CsmaStarHelper_GetSpokeIpv6Address, METH_KEYWORDS|METH_VARARGS, NULL },
