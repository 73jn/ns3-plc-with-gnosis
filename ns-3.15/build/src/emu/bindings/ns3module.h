...
extern PyTypeObject PyNs3EmuHelper_Type;

class PyNs3EmuHelper__PythonHelper : public ns3::EmuHelper
{
public:
    PyObject *m_pyself;
    PyNs3EmuHelper__PythonHelper(ns3::EmuHelper const & arg0)
        : ns3::EmuHelper(arg0), m_pyself(NULL)
        {}

    PyNs3EmuHelper__PythonHelper()
        : ns3::EmuHelper(), m_pyself(NULL)
        {}
    ...
    virtual ~PyNs3EmuHelper__PythonHelper()
    {
        Py_CLEAR(m_pyself);
    }
...
typedef struct {
    PyObject_HEAD
    ns3::EmuNetDevice *obj;
    PyObject *inst_dict;
    PyBindGenWrapperFlags flags:8;
} PyNs3EmuNetDevice;


extern PyTypeObject PyNs3EmuNetDevice_Type;
