...
PyTypeObject PyNs3SimpleRefCount__Ns3FlowProbe_Ns3Empty_Ns3DefaultDeleter__lt__ns3FlowProbe__gt___Type = {
    PyObject_HEAD_INIT(NULL)
    0,                                 /* ob_size */
    (char *) "flow_monitor.SimpleRefCount__Ns3FlowProbe_Ns3Empty_Ns3DefaultDeleter__lt__ns3FlowProbe__gt__",            /* tp_name */
...
static PyObject* _wrap_Pystd__vector__lt___ns3__Ptr__lt___ns3__FlowProbe___gt_____gt__Iter__tp_iternext(Pystd__vector__lt___ns3__Ptr__lt___ns3__FlowProbe___gt_____gt__Iter *self)
{
    ...
    wrapper_lookup_iter = PyNs3Empty_wrapper_registry.find((void *) const_cast<ns3::FlowProbe *> (ns3::PeekPointer ((*iter))));
    if (wrapper_lookup_iter == PyNs3Empty_wrapper_registry.end()) {
        py_FlowProbe = NULL;
    } else {
    ...
    if (py_FlowProbe == NULL) {
        wrapper_type = PyNs3SimpleRefCount__Ns3FlowProbe_Ns3Empty_Ns3DefaultDeleter__lt__ns3FlowProbe__gt____typeid_map.lookup_wrapper(typeid((*const_cast<ns3::FlowProbe *> (ns3::PeekPointer ((*iter))))), &PyNs3FlowProbe_Type);
        py_FlowProbe = PyObject_New(PyNs3FlowProbe, wrapper_type);
        ...
        PyNs3Empty_wrapper_registry[(void *) py_FlowProbe->obj] = (PyObject *) py_FlowProbe;
    }
...
initflow_monitor(void)
{
    ...
    PyModule_AddObject(m, (char *) "_PyNs3SimpleRefCount__Ns3FlowProbe_Ns3Empty_Ns3DefaultDeleter__lt__ns3FlowProbe__gt____typeid_map", PyCObject_FromVoidPtr(&PyNs3SimpleRefCount__Ns3FlowProbe_Ns3Empty_Ns3DefaultDeleter__lt__ns3FlowProbe__gt____typeid_map, NULL));
    ...
    PyModule_AddObject(m, (char *) "Std__map__lt___unsigned_int__unsigned_int___gt__Iter", (PyObject *) &Pystd__map__lt___unsigned_int__unsigned_int___gt__Iter_Type);
    {
        ...
        tmp_value = PyInt_FromLong(ns3::Ipv4FlowProbe::DROP_FRAGMENT_TIMEOUT);
