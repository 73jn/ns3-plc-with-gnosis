...
PyTypeObject Pyns3__olsr__MprSet_Type = {
    PyObject_HEAD_INIT(NULL)
    0,                                 /* ob_size */
    (char *) "olsr.Ns3__olsr__MprSet",            /* tp_name */
...
PyTypeObject Pyns3__olsr__MprSetIter_Type = {
    PyObject_HEAD_INIT(NULL)
    0,                                 /* ob_size */
    (char *) "olsr.Ns3__olsr__MprSetIter",            /* tp_name */
...
PyTypeObject Pystd__vector__lt___ns3__Ipv4Address___gt___Type = {
    PyObject_HEAD_INIT(NULL)
    0,                                 /* ob_size */
    (char *) "olsr.Std__vector__lt___ns3__Ipv4Address___gt__",            /* tp_name */
...
PyTypeObject Pystd__vector__lt___ns3__Ipv4Address___gt__Iter_Type = {
    PyObject_HEAD_INIT(NULL)
    0,                                 /* ob_size */
    (char *) "olsr.Std__vector__lt___ns3__Ipv4Address___gt__Iter",            /* tp_name */
...
initolsr(void)
{
    ...
    PyModule_AddObject(m, (char *) "_PyNs3OlsrState_wrapper_registry", PyCObject_FromVoidPtr(&PyNs3OlsrState_wrapper_registry, NULL));
