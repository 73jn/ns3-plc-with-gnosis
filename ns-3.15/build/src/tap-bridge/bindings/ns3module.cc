...
static PyMethodDef PyNs3TapBridgeHelper_methods[] = {
    {(char *) "SetAttribute", (PyCFunction) _wrap_PyNs3TapBridgeHelper_SetAttribute, METH_KEYWORDS|METH_VARARGS, NULL },
