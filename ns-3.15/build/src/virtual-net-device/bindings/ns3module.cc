...
_wrap_PyNs3VirtualNetDevice_Send(PyNs3VirtualNetDevice *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (PyObject_IsInstance(dest, (PyObject*) &PyNs3Address_Type)) {
        ...
        PyErr_Format(PyExc_TypeError, "parameter must an instance of one of the types (Address, Ipv4Address, Ipv6Address), not %s", dest->ob_type->tp_name);
        return NULL;
    }
...
_wrap_PyNs3VirtualNetDevice_SendFrom(PyNs3VirtualNetDevice *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (PyObject_IsInstance(source, (PyObject*) &PyNs3Address_Type)) {
        ...
        PyErr_Format(PyExc_TypeError, "parameter must an instance of one of the types (Address, Ipv4Address, Ipv6Address), not %s", source->ob_type->tp_name);
        return NULL;
    }
    if (PyObject_IsInstance(dest, (PyObject*) &PyNs3Address_Type)) {
        dest2 = *((PyNs3Address *) dest)->obj;
...
_wrap_PyNs3VirtualNetDevice_Receive(PyNs3VirtualNetDevice *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (PyObject_IsInstance(destination, (PyObject*) &PyNs3Address_Type)) {
        ...
        PyErr_Format(PyExc_TypeError, "parameter must an instance of one of the types (Address, Ipv4Address, Ipv6Address), not %s", destination->ob_type->tp_name);
        return NULL;
    }
...
_wrap_PyNs3VirtualNetDevice_SetSendCallback(PyNs3VirtualNetDevice *self, PyObject *args, PyObject *kwargs)
{
    PyObject *py_retval;
    PyObject *transmitCb;
    ns3::Ptr<PythonCallbackImpl2> transmitCb_cb_impl;
    ...
    transmitCb_cb_impl = ns3::Create<PythonCallbackImpl2> (transmitCb);
...
_wrap_PyNs3VirtualNetDevice_SetAddress(PyNs3VirtualNetDevice *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (PyObject_IsInstance(address, (PyObject*) &PyNs3Address_Type)) {
        ...
        PyErr_Format(PyExc_TypeError, "parameter must an instance of one of the types (Address, Ipv4Address, Ipv6Address), not %s", address->ob_type->tp_name);
        return NULL;
    }
